...
audioPath="/ssdtemp/dataset/audio/Kontrol/"
#featPath="$taskPath/$task/features/$outputName/$outputName"
featPath="$taskPath/$task/features/Kont/$outputName"
specPath="$taskPath/$task/spectra/Kont/$outputName"
#labels="/home/spa/git/ds/experiments/eat/labels/labels-prepared.csv"

#nets="AlexNet VGG16" # alex good
nets="AlexNet"
#layers="fc6 fc7 fc8" # try all
layers="fc6 fc7"
